...
export function Sidebar() {
  ...
  return (
    <nav className="relative z-10 flex w-[248px] shrink-0 flex-col border-r bg-card px-3 py-4">
                ...
                return (
                  <Link
                    ...
                    className={cn(
                      ...
                      active
                        ? "bg-accent font-medium text-foreground before:absolute before:-left-3 before:bottom-2 before:top-2 before:w-[3px] before:rounded-r-full before:bg-brand"
                        : "text-muted-foreground hover:bg-accent/60 hover:text-foreground",
                    )}
                  >
                    <Icon className={cn("h-4 w-4 shrink-0", active && "text-success")} />
